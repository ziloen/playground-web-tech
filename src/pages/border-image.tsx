...
export default function BorderImage() {
  return (
    <div className="size-full">
      ...
      <div
        className="size-40 resizable rounded-2xl bg-white/10"
        style={{
          borderImageSource: `url("data:image/svg+xml,%3Csvg%20xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg'%20width%3D'6'%20height%3D'6'%20viewBox%3D'0%200%206%206'%3E%3Cdefs%3E%3Cpattern%20id%3D'a'%20width%3D'2'%20height%3D'2'%20patternUnits%3D'userSpaceOnUse'%3E%3Cpath%20fill%3D'%23333'%20d%3D'M0%200h2v2H0z'%2F%3E%3Cpath%20fill%3D'%23ff0'%20d%3D'm0%201%201-1h1L0%202zm1%201%201-1v1z'%2F%3E%3C%2Fpattern%3E%3C%2Fdefs%3E%3Cpath%20fill%3D'url(%23a)'%20d%3D'M0%200h6v6H0z'%2F%3E%3C%2Fsvg%3E")`,
          borderImageSlice: '2',
      ...
      >
        <defs>
          <pattern id="pattern-border-image" width="2" height="2" patternUnits="userSpaceOnUse">
        ...
        <rect x="0" y="0" width="6" height="6" fill="url(#pattern-border-image)" />
      </svg>
    </div>
  )
}
...
function Setting() {
  return (
    ...
    >
      {/* border image 向外延申距离 */}
      <Field.Root name="border-image-outset" className="col-span-full grid grid-cols-subgrid">
      ...
      <Field.Root name="border-image-repeat" className="col-span-full grid grid-cols-subgrid">
