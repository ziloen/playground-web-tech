    ...
    <div>
      ...
      <div className="flex items-center">
        ...
        <div className="flex flex-col gap-2">
          ...
          <datalist
            id={datalistId}
            className="flex min-w-0 grow flex-col justify-between text-center text-sm leading-none opacity-65 writing-vertical-lr"
            style={{
      ...
      >
        <pre className="my-2">
          <code className="font-fira-code">{`const noop = () => {}`}</code>
        </pre>
        ...
        <div className="font-fira-code">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas alias vero aperiam
          reprehenderit qui totam, corrupti illo at sunt autem deserunt voluptas molestiae
          aspernatur, doloremque quos esse cupiditate soluta fugiat.
        </div>
      </motion.div>
    </div>
  )
